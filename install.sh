...
echo ""
echo -e "  ${BOLD}📋 Common CLI commands:${RESET}"
echo ""
echo -e "     ${DIM}# Scan a repo${RESET}"
echo -e "     ${CYAN}$PYTHON scanner.py --repo owner/repo${RESET}"
echo ""
echo -e "     ${DIM}# Scan all repos of a user${RESET}"
echo -e "     ${CYAN}$PYTHON scanner.py --user someusername --token ghp_xxx${RESET}"
echo ""
echo -e "     ${DIM}# Deep scan (commits, PRs, issues, gists)${RESET}"
echo -e "     ${CYAN}$PYTHON scanner.py --repo owner/repo --mode deep${RESET}"
echo ""
echo -e "     ${DIM}# Global search across GitHub${RESET}"
echo -e "     ${CYAN}$PYTHON scanner.py --global AKIA --token ghp_xxx${RESET}"
echo ""
echo -e "     ${DIM}# Export HTML report${RESET}"
echo -e "     ${CYAN}$PYTHON scanner.py --repo owner/repo --output report.html${RESET}"
echo ""
